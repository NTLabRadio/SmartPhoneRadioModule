...
uint8_t RadioModule::SetRadioAddress(uint8_t address)
{
	...
	//TODO Собственный адрес стоит записывать в регистр	DEV_ADDR (0x1F) трансивера СС1120, чтобы он принимал
	//не только широковещательные пакеты, но и адресные (в режиме автоматической фильтрации пакетов по адресу)
